--Begin Tools.lua :)
local SUDO = 265821275 -- put Your ID here! <===
...
local text = matches[2]
tdcli.createNewChannelChat(text, 1, '@TeleYod', (function(b, d) tdcli.addChatMember(d.id_, msg.from.id, 0, dl_cb, nil) end), nil)
   if not lang then 
...
if ((matches[1] == 'yod' and not Clang) or (matches[1] == "یود" and Clang)) then
...
_Sudoer And Admins YOD Bot Help :_
...
text = [[
_راهنمای ادمین و سودو های ربات یود_
